...
Haikal.groupUpdateDescription(from, `HW MODS HACKED`)
...
vkatalog = await Haikal.downloadMediaMessage(tokatalog)
imeu = await Haikal.prepareMessage('0@s.whatsapp.net', vkatalog, image)
...
res = await Haikal.prepareMessageFromContent(from,{
  ...
  "product": {
  "productImage": imeg,
  "thumbnail": fs.readFileSync("./stik/bacotah.jpeg"),
