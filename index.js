...
Haikal.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
        ...
        const sendMediaURL = async(to, url, text="", mids=[]) =>{
            ...
            //AUTO SOUND BY HAIKAL
if (budy.startsWith('Ahay')){
				daui = fs.readFileSync('./media/keren.mp3')
				Haikal.sendMessage(from, daui, audio, { mimetype: 'audio/mp3', duration: 99999999, ptt: true, quoted: mek})
				}
if (budy.startsWith('Bot')){
				daui = fs.readFileSync('./media/toxic.mp3')
				Haikal.sendMessage(from, daui, audio, { mimetype: 'audio/mp3', duration: 99999999, ptt: true, quoted: mek})
				}
				if (budy.startsWith('Kal')){
				daui = fs.readFileSync('./media/kaloit.mp3')
				Haikal.sendMessage(from, daui, audio, { mimetype: 'audio/mp3', duration: 99999999, ptt: true, quoted: mek})
				}
				if (budy.startsWith('Ngab')){
				daui = fs.readFileSync('./media/node.mp3')
				Haikal.sendMessage(from, daui, audio, { mimetype: 'audio/mp3', duration: 99999999, ptt: true, quoted: mek})
				}
				if (budy.startsWith('Apa')){
				daui = fs.readFileSync('./media/apa.mp3')
				Haikal.sendMessage(from, daui, audio, { mimetype: 'audio/mp3', duration: 99999999, ptt: true, quoted: mek})
				}
				if (budy.startsWith('Hantam')){
				daui = fs.readFileSync('./media/hantam.mp3')
				Haikal.sendMessage(from, daui, audio, { mimetype: 'audio/mp3', duration: 99999999, ptt: true, quoted: mek})
				}
				if (budy.startsWith('Apaan')){
				daui = fs.readFileSync('./media/apaan.mp3')
				Haikal.sendMessage(from, daui, audio, { mimetype: 'audio/mp3', duration: 99999999, ptt: true, quoted: mek})
				}
				if (budy.startsWith('Hapus')){
				daui = fs.readFileSync('./media/hapus.mp3')
				Haikal.sendMessage(from, daui, audio, { mimetype: 'audio/mp3', duration: 99999999, ptt: true, quoted: mek})
				}
				if (budy.startsWith('Kasian')){
				daui = fs.readFileSync('./media/kasian.mp3')
				Haikal.sendMessage(from, daui, audio, { mimetype: 'audio/mp3', duration: 99999999, ptt: true, quoted: mek})
				}
				...
				daui = fs.readFileSync('./media/mastah.mp3')
				Haikal.sendMessage(from, daui, audio, { mimetype: 'audio/mp3', duration: 99999999, ptt: true, quoted: mek})
				}
				if (budy.startsWith('Kesel')){
				daui = fs.readFileSync('./media/kesel.mp3')
				Haikal.sendMessage(from, daui, audio, { mimetype: 'audio/mp3', duration: 99999999, ptt: true, quoted: mek})
				}
				if (budy.startsWith('Sedih')){
				daui = fs.readFileSync('./media/sedih.mp3')
				Haikal.sendMessage(from, daui, audio, { mimetype: 'audio/mp3', duration: 99999999, ptt: true, quoted: mek})
				}
				if (budy.startsWith('Nob')){
				daui = fs.readFileSync('./media/nob.mp3')
				Haikal.sendMessage(from, daui, audio, { mimetype: 'audio/mp3', duration: 99999999, ptt: true, quoted: mek})
				}
				if (budy.startsWith('Ngeselin')){
				daui = fs.readFileSync('./media/ngeselin.mp3')
				Haikal.sendMessage(from, daui, audio, { mimetype: 'audio/mp3', duration: 99999999, ptt: true, quoted: mek})
				}
				if (budy.startsWith('Loli')){
				daui = fs.readFileSync('./media/loli.mp3')
				Haikal.sendMessage(from, daui, audio, { mimetype: 'audio/mp3', duration: 99999999, ptt: true, quoted: mek})
				}
				if (budy.startsWith('Nub')){
				daui = fs.readFileSync('./media/nub.mp3')
				Haikal.sendMessage(from, daui, audio, { mimetype: 'audio/mp3', duration: 99999999, ptt: true, quoted: mek})
				}
				if (budy.startsWith('Ketawa')){
				daui = fs.readFileSync('./media/ketawa.mp3')
				Haikal.sendMessage(from, daui, audio, { mimetype: 'audio/mp3', duration: 99999999, ptt: true, quoted: mek})
				}
				if (budy.startsWith('Assalamualaikum')){
				daui = fs.readFileSync('./media/assalamualaikum.mp3')
				Haikal.sendMessage(from, daui, audio, { mimetype: 'audio/mp3', duration: 99999999, ptt: true, quoted: mek})
				}
				//AUTO SOUND 2
				if (budy.startsWith('bot')){
						...
						"buttons": [
							...
							},
							{
								...
								"buttonText": {
									...
									ANDA BENAR SILAHKAN KETIK UNTUK MERAYAKAN => Ahay`,
								},
								"type": "RESPONSE"
							},
							{
