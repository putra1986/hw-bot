...
exports.jadibot = async function(Haikal,from,sender,reply,mek) {  
conn.on('qr' ,async qr => {
  ...
  auth = true
    ...
    let scen = await Haikal.sendMessage(from, fs.readFileSync('./jadibot.jpg'), MessageType.image, {quoted : mek,caption: 'Scan QR ini untuk jadi bot sementara!\n1. Klik titik tiga di pojok kanan atas\n2. Ketuk WhatsApp Web\n3. Scan QR ini \n\nQR Expired dalam 20 detik'})
